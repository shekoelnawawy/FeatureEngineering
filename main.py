...
patient = patients[0]
df_0 = joblib.load('/home/mnawawy/FeatureEngineering/2020data/'+patient+'.'+split+'.pkl')
patient = patients[1]
df_1 = joblib.load('/home/mnawawy/FeatureEngineering/2020data/'+patient+'.'+split+'.pkl')
patient = patients[2]
df_2 = joblib.load('/home/mnawawy/FeatureEngineering/2020data/'+patient+'.'+split+'.pkl')
patient = patients[3]
df_3 = joblib.load('/home/mnawawy/FeatureEngineering/2020data/'+patient+'.'+split+'.pkl')
patient = patients[4]
df_4 = joblib.load('/home/mnawawy/FeatureEngineering/2020data/'+patient+'.'+split+'.pkl')
patient = patients[5]
df_5 = joblib.load('/home/mnawawy/FeatureEngineering/2020data/'+patient+'.'+split+'.pkl')
patient = patients[6]
df_6 = joblib.load('/home/mnawawy/FeatureEngineering/2018data/'+patient+'.'+split+'.pkl')
patient = patients[7]
df_7 = joblib.load('/home/mnawawy/FeatureEngineering/2018data/'+patient+'.'+split+'.pkl')
patient = patients[8]
df_8 = joblib.load('/home/mnawawy/FeatureEngineering/2018data/'+patient+'.'+split+'.pkl')
patient = patients[9]
df_9 = joblib.load('/home/mnawawy/FeatureEngineering/2018data/'+patient+'.'+split+'.pkl')
patient = patients[10]
df_10 = joblib.load('/home/mnawawy/FeatureEngineering/2018data/'+patient+'.'+split+'.pkl')
patient = patients[11]
df_11 = joblib.load('/home/mnawawy/FeatureEngineering/2018data/'+patient+'.'+split+'.pkl')
